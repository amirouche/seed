#!r6rs
;;;
;;; Seed2 Nanopass Compiler — Unified Vau with define!
;;;
...
(library (seed2)
  (export
    ...
    ;; define helpers
    has-define? collect-defines define-name-sym codegen-begin
  ...
  ;; Load implementation from src/seed2.scm
  (include "src/seed2.scm")
