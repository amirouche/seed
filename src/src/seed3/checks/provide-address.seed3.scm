;; Test: provide macro with encapsulation-based record type.
;; Uses provide (a vau macro) to export an address constructor,
;; predicate, and accessors, built on make-encapsulation-type.
(define provide
